...
module.exports = {
    ...
    _getProblemIO: function(html, cb) {
        ...
        _.assign(problemIO, {
            statement: $('#pageContent > div.problemindexholder > div > div > div:nth-child(2)').text(),
            inputSpec: $('#pageContent > div.problemindexholder > div > div > div.input-specification').text(),
            outputSpec: $('#pageContent > div.problemindexholder > div > div > div.output-specification').text(),
