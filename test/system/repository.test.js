    ...
    describe('package.json', function () {
        ...
        describe('package.json JSON data', function () {
            it('must have valid name, description and author', function () {
                expect(json).to.have.property('name', 'nodeforces');
                expect(json).to.have.property('description', 'The only codeforces helper you\'ll ever need');
                expect(json).to.have.property('author', 'Krishna Kalubandi <krishnakalubandi@gmail.com>');
                expect(json).to.have.property('license', 'MIT');
                expect(json).to.have.property('homepage', 'https://github.com/kp96/nodeforces');
                expect(json).to.have.property('bugs', 'https://github.com/kp96/nodeforces/issues');
